...
status-project = Project { $value }
status-project-type = Type { $value }
status-workflow = Workflow { $value }
status-task = Task { $value }
status-branch = Branch { $value }
status-base = Base { $value }
status-changes = Changes
status-files = Files: { $count }
status-added = Added: { $count }
status-modified = Modified: { $count }
status-deleted = Deleted: { $count }
status-type-changed = Type changed: { $count }
status-untracked = Untracked: { $count }
status-intent-to-add = Intent to add: { $count }
status-conflicts = Conflicts: { $count }
status-synchronization = Synchronization with remote base
status-ahead = Local ahead: { $count }
status-behind = Remote ahead: { $count }
status-locks = Locks
