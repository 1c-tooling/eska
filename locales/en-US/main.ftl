...
start-remote-base-missing = Remote base reference { $reference } was not found after fetch.
...
start-fetch-error = Could not fetch changes from the remote Git repository.
