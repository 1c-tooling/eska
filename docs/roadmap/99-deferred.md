...
| Фоновый prefetch метаданных | DEFERRED | Отдельная оптимизация только по замерам T68; не условие первой lazy реализации |
...
metadata/IDE milestones T60–T74. Наличие других идей в общем backlog не
расширяет их scope. Backend read-only protocol выполняется в T69–T70 до T41;
разработка самого VS Code extension остаётся отдельной задачей.
