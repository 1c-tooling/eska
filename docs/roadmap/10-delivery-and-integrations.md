...
Сводная задача, декомпозированная в [T76–T81](14-vscode-extension.md).
...
как дополнительные интеграции зависят от T12–T18, T21, T27, T37–T39 и добавляются
отдельно; собственные команды навигации T76–T79 входят в первую версию.
Не реализовывать VCS повторно в TypeScript; все операции идут через стабильный
core/CLI protocol.
