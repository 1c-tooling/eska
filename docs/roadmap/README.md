...
- `NEXT`: `T58` — настройка основной production-ветки Git Flow без изменения
  базы feature-веток;
- `PLANNED`: `T59` — однозначные подписи источника изменений в human-выводе
  `eska diff` после T58;
...
| 2 | T59 | Читаемые подписи источника изменений в `eska diff` |
...
| T59 | PLANNED | Читаемые подгруппы human-вывода `eska diff` | [04-core-vcs-ux.md](04-core-vcs-ux.md) |
