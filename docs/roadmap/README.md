...
- `NEXT`: `T81` — итоговая приёмка и VSIX;
...
Поиск T78, фильтр T79 и иконки T80 реализованы. Следующая задача — T81: итоговая приёмка и VSIX. T56 остаётся в backlog.
...
| 18 | T81 | Приёмка скорости/UI и VSIX; закрытие T41 — `NEXT` |
...
| T81 | NEXT | Производительность интерфейса, приёмка и VSIX | [14-vscode-extension.md](14-vscode-extension.md) |
