...
- `NEXT`: `T77` — дерево, модули и открытие исходников;
...
Следующая задача — T77: дерево, модули и открытие исходников в расширении. T56 остаётся в backlog.
...
| T77 | NEXT | Дерево проектов, модули и открытие исходников | [14-vscode-extension.md](14-vscode-extension.md) |
