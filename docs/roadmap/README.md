...
- `IN-PROGRESS`: `T80` — иконки метаданных;
...
Поиск T78 и фильтр T79 реализованы. Следующая задача — T80: иконки метаданных. T56 остаётся в backlog.
...
| 17 | T80 | Иконки метаданных — `IN-PROGRESS` |
...
| T80 | IN-PROGRESS | Иконки метаданных | [14-vscode-extension.md](14-vscode-extension.md) |
