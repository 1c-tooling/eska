...
Стадия проекта: **repository layer завершён**, далее workflow policy model.
...
- `IN-PROGRESS`: `T08` — workflow policy model;
...
| T08 | IN-PROGRESS | Workflow policy model | [03-repository-workflow.md](03-repository-workflow.md) |
