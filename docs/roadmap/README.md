...
- `NEXT`: `T03` — project discovery и полная validation;
- прикладных команд, discovery и VCS-функций пока нет.
...
| T03 | NEXT | Project discovery и validation | [01-project-foundation.md](01-project-foundation.md) |
