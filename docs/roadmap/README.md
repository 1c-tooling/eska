...
- `NEXT`: `T79` — фильтр пустых разделов корня и исходная настройка;
...
Поиск T78 реализован. Следующая задача — T79: фильтр пустых разделов корня и исходная настройка. T56 остаётся в backlog.
...
| 16 | T79 | Фильтр пустых групп и исходная настройка — `NEXT` |
...
| T79 | NEXT | Фильтр пустых групп и настройка исходного режима | [14-vscode-extension.md](14-vscode-extension.md) |
