...
- `NEXT`: `T78` — поиск и переход к результату в расширении;
...
Следующая задача — T78: поиск и переход к результату в расширении. T56 остаётся в backlog.
...
| T78 | NEXT | Поиск в расширении и переход к результату | [14-vscode-extension.md](14-vscode-extension.md) |
