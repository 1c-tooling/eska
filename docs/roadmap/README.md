...
- `NEXT`: `T54` — паспорт собранного артефакта;
- `PLANNED`: `T55` — переносимые проверки сборки;
...
|---|---|---|
| 1 | T54 | Паспорт артефакта, связанный с фактическим снимком исходников |
| 2 | T55 | Переносимые проверки build и протокол приёмки на поддерживаемых ОС |
...
| T54 | NEXT | Паспорт собранного артефакта | [12-current-functionality.md](12-current-functionality.md) |
