...
`NEXT` — T65. Декомпозиция backend, поиска и открытых решений —
...
подготовка `eska` и расширения VS Code для Designer XML. Текущий `NEXT` — T65.
...
6. T65 — схемы дерева, группа модулей и пустые коллекции, NEXT
