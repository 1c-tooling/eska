...
Текущий baseline — завершены T01–T22, T25, T28–T29, T34, T40, T42–T50:
...
```text
1. T51 — предварительный просмотр save, IN-PROGRESS
2. T52 — предварительный просмотр build
3. T53 — finish после squash/rebase, NEEDS-SPEC до реализации
4. T54 — паспорт собранного артефакта
5. T55 — переносимые проверки сборки
