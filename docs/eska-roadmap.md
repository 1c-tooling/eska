...
`NEXT` — T67. Декомпозиция backend, поиска и открытых решений —
...
подготовка `eska` и расширения VS Code для Designer XML. Текущий `NEXT` — T67.
...
8. T67 — lazy cache и инкрементальное обновление, NEXT
