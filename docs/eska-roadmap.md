...
`NEXT` — T61. Декомпозиция backend, поиска и открытых решений —
...
подготовка `eska` и расширения VS Code для Designer XML. Текущий `NEXT` — T61.
...
2. T61 — обязательный manifest, Designer resolver и source mapping, NEXT
