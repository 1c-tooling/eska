...
P4 — следующее крупное расширение VCS
T37 sync / continue / abort одной задачей

После P0–P4, последней в текущей очереди
T26 fmt
```
...
внешнего runner не блокирует T35, T56 и T37 на текущей системе.
...
описан в [T56](roadmap/10-delivery-and-integrations.md). T51–T52 и T54 завершены;
