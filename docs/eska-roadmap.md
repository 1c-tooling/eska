...
```text
1. T52 — предварительный просмотр build, NEXT
2. T53 — finish после squash/rebase, NEEDS-SPEC до реализации
3. T54 — паспорт собранного артефакта
4. T55 — переносимые проверки сборки
