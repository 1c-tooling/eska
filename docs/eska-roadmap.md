...
Текущий baseline — завершены T01–T22, T25, T28–T29, T34, T40, T42–T52:
...
```text
1. T54 — паспорт собранного артефакта, NEXT
2. T55 — переносимые проверки сборки
...
[трекере](roadmap/README.md). T51–T52 завершены. T53 сначала требует спецификации
