...
`NEXT` — T75. Декомпозиция backend, поиска и открытых решений —
...
подготовка `eska` и расширения VS Code для Designer XML. Текущий `NEXT` — T75.
...
9. T75 — индекс и API поиска, NEXT
