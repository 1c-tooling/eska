...
T59 однозначные подписи источника изменений в human-выводе eska diff
...
2. T59 — читаемые подписи источника изменений в human-выводе eska diff
...
внешнего runner не блокирует T58, T59, T35, T56, T57 и T37 на текущей системе.
