...
P3 — следующее крупное расширение VCS
T37 sync / continue / abort одной задачей

После P0–P3, последней в текущей очереди
T26 fmt
```
