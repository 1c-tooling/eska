...
`NEXT` — T63. Декомпозиция backend, поиска и открытых решений —
...
подготовка `eska` и расширения VS Code для Designer XML. Текущий `NEXT` — T63.
...
4. T63 — выбор XML parsing и исходные замеры, NEXT
